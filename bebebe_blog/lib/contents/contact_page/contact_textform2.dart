...
class ContactTextformWidget extends StatefulWidget {
  ContactTextformWidget({Key? key, required double this.width, required String this.heading}) : super(key: key);
...
class ContactTextformView extends State<ContactTextformWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    this.primaryStyle = GoogleFonts.kosugiMaru(fontSize: widget.width < 640 ? 16 : 20, fontWeight: FontWeight.w400, height: 1.75);
    this.focusStyle = GoogleFonts.kosugiMaru(fontSize: widget.width < 640 ? 10 : 15, fontWeight: FontWeight.w400, height: 1.75, color: this.focusNode.hasFocus ? mainblue : subgrey);
    ...
    return SizedBox(
      ...
      child: Stack(children: [
        ...
        Align(alignment: const Alignment(0, -1), child: this.underLine),
      ]),
    );
  } // end of build
} // end of class
